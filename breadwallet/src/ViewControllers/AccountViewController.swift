...
class AccountViewController : UIViewController, Subscriber {
    ...
    private func addConstraints() {
        ...
        headerContainer.constrain([ headerContainer.constraint(.height, constant: E.isIPhoneXSeries ? accountHeaderHeight + 14.0 : accountHeaderHeight) ])
        headerView.constrain(toSuperviewEdges: nil)

        footerView.constrainBottomCorners(sidePadding: 0, bottomPadding: 0)
        footerView.constrain([
            footerView.constraint(.height, constant: E.isIPhoneXSeries ? footerHeight + 19.0 : footerHeight) ])
        ...
        addChildViewController(transactionsTableView, layout: {
            ...
            if #available(iOS 11, *) {
                transactionsTableView.tableView.contentInset =
                    UIEdgeInsets(top: E.isIPhoneXSeries ? accountHeaderHeight + 14 : accountHeaderHeight + C.padding[2],
                                 left: 0,
                                 bottom: E.isIPhoneXSeries ? footerHeight + C.padding[2] + 19 : footerHeight + C.padding[2],
                                 right: 0)
            } else {
                transactionsTableView.tableView.contentInset =
                    UIEdgeInsets(top: E.isIPhoneXSeries ? accountHeaderHeight + C.padding[2] + 14 : accountHeaderHeight + C.padding[2],
                                 left: 0,
                                 bottom: E.isIPhoneXSeries ? footerHeight + C.padding[2] + 19 : footerHeight + C.padding[2],
                                 right: 0)
            }
            transactionsTableView.tableView.scrollIndicatorInsets =
                UIEdgeInsets(top: E.isIPhoneXSeries ? accountHeaderHeight + 14 : accountHeaderHeight,
                             left: 0,
                             bottom: E.isIPhoneXSeries ? footerHeight + 19 : footerHeight,
                             right: 0)
        })
    }
