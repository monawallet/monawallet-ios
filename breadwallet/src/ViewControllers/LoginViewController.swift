    ...
    private func addConstraints() {
        ...
        if walletManager != nil {
            addChildViewController(pinPad, layout: {
                pinPadPottom = pinPad.view.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: E.isIPhoneXSeries ? -C.padding[3] : 0.0)
        ...
        topControlTop = topControlContainer.topAnchor.constraint(equalTo: view.topAnchor, constant: E.isIPhoneXSeries ? C.padding[1] + 35.0 : C.padding[1] + 20.0)
