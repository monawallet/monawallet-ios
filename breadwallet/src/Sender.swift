...
class Sender {
    ...
    private func postProtocolPaymentIfNeeded() {
        ...
        request.setValue("application/monacoin-payment", forHTTPHeaderField: "Content-Type")
        request.addValue("application/monacoin-paymentack", forHTTPHeaderField: "Accept")
        ...
        URLSession.shared.dataTask(with: request as URLRequest) { data, response, error in
            ...
            if response.mimeType == "application/monacoin-paymentack" && data.count <= 50000 {
